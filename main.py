...
#Wyświetl wstęp:
print('''Parados dnia urodzin
      
Parados dnia urodzin pokazuje, że w grupie N osób szansa,
...
(To tak naprawdę nie jest paradokds, tylko zaskakujący wynik.)
''')
...
for i, birthday in enumerate(birthdays):
    if i != 0:
        #Po pierwszym dniu wyświetl przecinek.
        print(', ', end='')
...
for i in range(100_000):
    #Wyświetlenie postępu co 10 000 symulacji:
    if i % 10_000 == 0:
        print(i, 'przprowadzonych symulacji...')
    birthdays = getBirthdays(numBDays)
